...
contract AkuAuction {
    ...
    uint256 public totalForAuction = 5495;   // original line 147 — auction capacity / bid cap
    uint256 public startingPrice;
    uint256 public startAt;
    uint256 public expiresAt;

    mapping(address => uint256) public bidsPlaced; // [0,1]
    mapping(address => uint256) public finalProcess; // [0,1]
    ...
    constructor(address _project, uint256 startingTime, uint256 _startingPrice) {
        ...
        expiresAt = startAt + 7560; // 126 minutes in seconds
    }
